...
t = parse(Float64, ARGS[17])
tp = parse(Float64, ARGS[18])
Delta = parse(Float64, ARGS[19])
tpz = parse(Float64, ARGS[20])
tc = parse(Float64, ARGS[21])
mumin = parse(Float64, ARGS[22])
mumax = parse(Float64, ARGS[23])
mupoints= parse(Int, ARGS[24])
